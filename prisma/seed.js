...
const PRODUCTS = [
  ...
  { slug: "amateur-flirt", name: "Amateur Flirt", category: "Abstract", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "If love doesn't work out, at least the aesthetic does.", artist: null, images: ["/products/amateur-flirt.jpg", "/products/amateur-flirt.jpg", "/products/amateur-flirt.jpg"], fixFormats: true, fixCategory: true },
  ...
  { slug: "crowned-fighter", name: "Crowned Fighter", category: "Sports", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "Boxing gloves up, crown on, not backing down from anything.", artist: null, images: ["/products/crowned-fighter.png", "/products/crowned-fighter.png", "/products/crowned-fighter.png"], fixCategory: true },
  ...
  { slug: "hoop-hero", name: "Hoop Hero", category: "Sports", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "One hand, one ball, one net — geometric and unapologetic.", artist: null, images: ["/products/hoop-hero.png", "/products/hoop-hero.png", "/products/hoop-hero.png"], fixCategory: true },
  ...
  { slug: "stormborn", name: "Stormborn", category: "Aviation", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "A plane landing through lightning, a skull on the wet tarmac below.", artist: null, images: ["/products/stormborn.png", "/products/stormborn.png", "/products/stormborn.png"], fixCategory: true },
  ...
  { slug: "infinite-vibes", name: "Infinite Vibes", category: "Psychedelic", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "Good vibes, bad decisions — a mouth that spirals straight into the cosmos.", artist: null, images: ["/products/infinite-vibes.png", "/products/infinite-vibes.png", "/products/infinite-vibes.png"], fixCategory: true },
  { slug: "cosmic-empathy", name: "Cosmic Empathy", category: "Psychedelic", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "A rave, a disco ball, and a moment of eyes-closed stillness in the middle of it.", artist: null, images: ["/products/cosmic-empathy.png", "/products/cosmic-empathy.png", "/products/cosmic-empathy.png"], fixCategory: true },
  ...
  { slug: "shattered-reality", name: "Shattered Reality", category: "Psychedelic", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "A shattered mirror, a burning eye, and a hundred small truths in the cracks.", artist: null, images: ["/products/shattered-reality.png", "/products/shattered-reality.png", "/products/shattered-reality.png"], fixCategory: true },
  ...
  { slug: "intuition-entered-chat", name: "Intuition Has Entered the Chat", category: "Psychedelic", price: 1499, widthCm: 100, formats: ["TAPESTRY", "CANVAS"], blurb: "One eye, a galaxy of purple smoke, and a slow pink drip down the frame.", artist: null, images: ["/products/intuition-entered-chat.png", "/products/intuition-entered-chat.png", "/products/intuition-entered-chat.png"], fixCategory: true },
